...
import * as Color from 'color'; //helps to treat colors:

//Import models
import { SwitchThemeModel } from '../models/switch-theme.model';

//Set default theme colors  
const DEFAULTS: SwitchThemeModel = {
  primary: '#0080ff',
  secondary: '#0cd1e8',
  tertiary: '#7044ff',
  success: '#10dc60',
...
export class ThemeSwitcherDirective {
  ...
  //Options
  @Input() colors: SwitchThemeModel = DEFAULTS;
  ...
  // Override all CSS variables with a new theme colors
  private switchTheme(theme: SwitchThemeModel) {
...
//Generate css text 
function GenerateCSS(colors: any) {

  //uses spread to array
